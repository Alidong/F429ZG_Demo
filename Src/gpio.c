...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, T_RST_Pin|LCD_BL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, LED_0_Pin|LED_1_Pin|T_SDA_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = T_RST_Pin|LCD_BL_Pin;
