...
static lv_fs_res_t fs_open(lv_fs_drv_t *drv, void *file_p, const char *path, lv_fs_mode_t mode)
{
    ...
    if (mode == LV_FS_MODE_WR)
    {
        ...
        res = f_open((file_t *)file_p, path, FA_WRITE);
        /* Add your code here*/
    }
    else if (mode == LV_FS_MODE_RD)
    {
        /*Open a file for read*/
        res = f_open((file_t *)file_p, path, FA_READ);
        /* Add your code here*/
    }
    else if (mode == (LV_FS_MODE_WR | LV_FS_MODE_RD))
    {
        /*Open a file for read and write*/
        res = f_open((file_t *)file_p, path, FA_WRITE | FA_READ);
        /* Add your code here*/
    }
...
static lv_fs_res_t fs_tell(lv_fs_drv_t *drv, void *file_p, uint32_t *pos_p)
{
    ...
    /* Add your code here*/
    pos_p = (uint32_t *)f_tell((file_t *)file_p);
    if (pos_p != NULL)
    {
        res = 0;
    }
...
static lv_fs_res_t fs_free(lv_fs_drv_t *drv, uint32_t *total_p, uint32_t *free_p)
{
    ...
    FATFS *pfs;
    pfs = &fs;
    res = f_getfree("", (DWORD *)free_p, &pfs);
    *total_p = (pfs->n_fatent - 2) * pfs->csize / 2 / 1024;
    *free_p = (*free_p) * pfs->csize / 2 / 1024;
    /* Add your code here*/
    return res;
}
...
static lv_fs_res_t fs_dir_open(lv_fs_drv_t *drv, void *rddir_p, const char *path)
{
    ...
    /* Add your code here*/
    res = f_opendir((DIR *)rddir_p, path);
    return res;
}
...
static lv_fs_res_t fs_dir_read(lv_fs_drv_t *drv, void *rddir_p, char *fn)
{
    ...
    /* Add your code here*/
    FILINFO *refn;
    res = f_readdir((DIR *)rddir_p, refn);
    fn = refn->fname;
    return res;
}
